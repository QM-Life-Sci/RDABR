...
Load the data in the file `Silver_fir.xlsx` (you will need to use `read_excel()` from the `readxl` package). Determine how missing data were coded in the file and pass the appropriate argument for NAs. 
...
```{r}
# FIXME
SF <- read_excel("../data/Silver_fir.xlsx", na = "NA") |> 
