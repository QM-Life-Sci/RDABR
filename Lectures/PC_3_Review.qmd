...
- Out-of-sample predictive ability (broad)
- Out-of-sample predictive ability (quantitative or numerical)
...
- Restricted to nested sets of predictors
    ...
    - `y ~ x1 + x2`
    - `y ~ x1 + x2 + X1:x2`
- Twice the difference in log-likelihood follows a $\chi^2$ distribution with df = difference in number of parameters
...
- "Vague" interpretation
    - What does 0.65 vs. 0.25 vs. 0.10 mean?
