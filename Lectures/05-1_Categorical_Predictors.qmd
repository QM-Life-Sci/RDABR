...
#| echo: false
#| warning: false
#| fig-alt: "Histogram of sample means with a sample size of 20 showing 100 random samples."
...
```{r}
#| warning: false
#| fig-alt: "Histogram of sample means with a sample size of 20 showing 1000 random samples."
...
```{r}
#| warning: false
#| fig-alt: "Histogram of sample means with a sample size of 20 showing 10000 random samples."
...
```{r}
#| warning: false
#| fig-alt: "Histogram of sample means with a sample size of 200 showing 100 random samples."
...
```{r}
#| warning: false
#| fig-alt: "Histogram of sample means with a sample size of 2000 showing 100 random samples."
...
```{r}
#| fig-alt: "Plot of values for the standard deviation from a set of 100 random samples for different sample sizes."
...
fig-alt="Image of a stickleback fish."}


## Stickleback plates

```{r}
#| fig-alt: "Set of histograms showing the distribution of lateral body plates in sticklebacks separately for each genotype."
...
#| fig-alt: "Scatterplot of the number of lateral body plates in stickleback versus genotype with means and standard errors overlayed on points."
...
```{r}
#| fig-alt: "Four scatterplots in a grid with each plot showing a scatterplot of phenotype versus treatment for two groups. Plots on the left show low variation within each group. Plots on the top show low sample size. Means are overlayed in a red point."
...
#| echo: true
#| output-location: slide
#| fig-alt: "Four scatterplots in a grid with each plot showing a scatterplot of phenotype versus treatment for two groups. Plots on the left show low variation within each group. Plots on the top show low sample size. Means and confidence intervals are overlayed in a red point."
...
![](http://www.lazerhorse.org/wp-content/uploads/2015/01/Flying-Snake-Chrysopelea.jpg){fig-align="center" width="60%" fig-alt="Image of a flying snake."}
...
![](https://tpwd.texas.gov/huntwild/wild/images/reptiles/horned_lizardlarge.jpg){fig-align="center" width=90% fig-alt="Image of a horned lizard."}
...
![](https://i.imgur.com/Q1ee6FQ.png){fig-align="center" width=90% fig-alt="Image of a loggerhead shrike holding a horned lizard."}
...
![](https://i.imgur.com/asOgPnC.jpg){fig-align="center" width=80% fig-alt="Image of a horned lizard impaled on a thorn."}
...
#| echo: true
#| output-location: slide
#| fig-alt: "Two histograms stacked vertically showing the distribution of horn length in the alive group (top) and the dead group (bottom) for simulated data."
...
```{r}
#| fig-alt: "Scatterplot of Horn Length versus group (alive or dead)."
...
```{r}
#| echo: true
#| fig-alt: "Scatterplot of Horn Length versus group (alive or dead). Means for each group are plotted as a horizontal line for each group. Red lines are plotted between the mean line and each data point "
...
#| fig-width: 14
#| fig-align: center
#| fig-alt: "Density plot of the distribution of body mass in lowland gorillas."
...
#| fig-width: 14
#| fig-align: center
#| fig-alt: "Density plot of the distribution of body mass in lowland gorillas with separate density plots by sex overlayed in different colors."
