...
7. What’s one thing we could do to improve your learning experience?
...
```{r}
#| fig-alt: "Histogram of number of plates in each of three genotypes: mm, Mm, and MM. Each genotype has a different shape of distribution which is summaried by different values for the mean and median."
