...
- Micropublication *plan* due next Tuesday
    - Ideas
    - Figure(s)
    - Table(s)
    - Planned analysis
...
ggplot(NMR, aes(x = Mass, y = Energy, color = Caste)) +
  ...
  theme(legend.position = "inside", legend.position.inside = c(0.15, 1)) +
...
- 0/1 representations of factors $\times$ continuous variables
- Just multiplication, nothing more complicated
