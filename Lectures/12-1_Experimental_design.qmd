...
- Calculated using an ANOVA
- Compares the variation within measurements to the variation between measurements
- Generally 0 $\rightarrow$ 1
    - Can be negative (bad)
...
- Estimated based on the distribution of p-values
