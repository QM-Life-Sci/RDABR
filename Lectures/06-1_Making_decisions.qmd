...
#| echo: true
#| fig-align: center
#| fig-alt: "Density plot showing the relative likelihood versus values for a normal distribtution. The tails of the distribution representing 2.5% of the density are shaded in pink."
