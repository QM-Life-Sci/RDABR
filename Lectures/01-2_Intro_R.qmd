...
subtitle: "Introduction to R, RStudio, and Hellbender and setting up your environment"
html-math-method:
  method: mathjax
...
# RStudio {background-color="#40666e"}
...
- Install once, use often
    ...
    - Don't include install code in your Rmd files
- `tidyverse`
- `cowplot`
