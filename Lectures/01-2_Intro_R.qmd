...
# Question of the week {background-color="#40666e"}

What is one technology that you hope we have in 50 years?


# Review and Questions {background-color="#40666e"}
...
- Graphical user interface to R ("IDE")
- R runs within [RStudio](https://posit.co/products/open-source/rstudio/?sid=1){target="_blank"}
- R can run outside of RStudio

![](images/RStudio.png){fig-align="center" fig-alt="Image of the main RStudio window."}
...
![](images/RStudio.png){fig-align="center" fig-alt="Image of RStudio application on launch."}


## Panes and tabs of the RStudio window
...
## R Console Pane: `>` prompt

- Interactive
- Enter and run code
- Run code from quarto files


## Source Pane

- Text editor
- Work in an quarto `qmd` file and send code to the console
...
- Loading packages is usually one of the first steps of an analysis
    - `library(...)` near the top of your qmd
...
## Let's install packages together

![](images/RStudio_packages.png){fig-align="center" fig-alt="Image of RStudio packages pane."}
...
![](images/RStudio_Working_Directory.png){fig-width=100% fig-align="center" fig-alt="Image of the RStudio window with an arrow pointing to the Working Directory."}

- All file system operations work relative to the working directory
- `~/` is your "home" or user directory


## RStudio Projects

![](images/RStudio_Project.png){fig-align="center" fig-alt="Image of the RStudio window with an arrow pointing to the Current Project."}
...
![](images/RStudio_Files.png){fig-width=100% fig-align="center" fig-alt="Image of the RStudio files pane with arrows pointing to the current directory, the .. to move up a directory level, and the Set As Working Directory button."}
...
![](images/Swirl.png){fig-align="center" fig-alt="Image of the main Swirl webpage."}
