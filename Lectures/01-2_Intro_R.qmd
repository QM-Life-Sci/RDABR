...
![](images/RStudio_Bare.png){fig-align="center" fig-alt="Image of RStudio application on launch."}
...
![](images/RStudio_Working_Directory.png){fig-align="center" fig-alt="Image of the RStudio window with an arrow pointing to the Working Directory."}
