...
Tues
- Introduce selves & students
- Introduce class goals
    - show with sci paper activity
    - in class writing reflection (how do we know things? what am i interested in?)
...
- take away assignment - revise reflection & reading for next week
...
- Previous week's problem set due (12:00 noon)

**Thursday**

- Finish up Tuesday lecture material
- Review / questions
- Questions for discussion due Wednesday at 11:59 PM
- Start problem set
...
- If you need more time on an assignment, you must get in touch with us *before it is due* for approval (when possible).
...
- [Large Language Models explained briefly](https://umsystem.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=b263e287-0f89-4f12-bcb9-b413017c9822){target="_blank"}
