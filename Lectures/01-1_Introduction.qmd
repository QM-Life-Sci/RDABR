...
- Grew up in Florida
- North Carolina $\rightarrow$ Rhode Island $\rightarrow$ California $\rightarrow$ Rhode Island $\rightarrow$ California $\rightarrow$ Missouri
...
- Probably
- Taught undergraduates, post-bacs, and graduate students these skills for 15+ years
...
-	Be willing to fail and keep trying.
    - This process is part of learning. Confusion is your mind adjusting to new information.
...
# Wellbeing {background-color="#40666e"}
...
- Check that you have access to [OnDemand](https://ondemand.rnet.missouri.edu/pun/sys/dashboard)
